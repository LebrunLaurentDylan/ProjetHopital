...
namespace HopitalDll
{
    public class HopitalVisitesSqlServer : IHopitalVisites
    {
        ...
        public List<Visites> FindAll()
        {
            ...
            while (reader.Read())
            {
                Visites a = new Visites(reader.GetInt32(0), reader.GetInt32(1), reader.GetString(2), reader.GetDateTime(3), reader.GetInt32(4), reader.GetInt32(5));
                liste.Add(a);
            }
        ...
        public List<Visites> FindByPatient(int idPatient)
        {
            ...
            while (reader.Read())
            {
                Visites vis = new Visites(reader.GetInt32(0), reader.GetInt32(1), reader.GetString(2), reader.GetDateTime(3), reader.GetInt32(4), reader.GetInt32(5));
                liste.Add(vis);
            }
